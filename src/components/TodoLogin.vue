...
<template>
  <div
    class="border-2 border-gray-400 rounded-md max-w-md m-auto my-14 text-center items-center h-auto"
  >
    <div class="my-4">
    ...
    <div class="my-6 flex gap-4 justify-center text-center items-center mb-6">
      ...
      class="border border-gray-400 rounded-md p-2 w-32 cursor-pointer">Google</div>
      <div class="border border-gray-400 rounded-md p-2 w-32 cursor-pointer">Facebok</div>
      <div class="border border-gray-400 rounded-md p-2 w-32 cursor-pointer">Github</div>
    </div>
  </div>
</template>
